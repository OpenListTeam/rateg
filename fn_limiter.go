...
// LimitFnReflect limits the function to be called only once at a specified time interval, implemented by reflection
func LimitFnReflect(f interface{}, interval time.Duration) func(...interface{}) []interface{} {
...
// LimitRate limits the function to be called only once at a specified time interval
...
// LimitRateCtx limits the function to be called only once at a specified time interval
